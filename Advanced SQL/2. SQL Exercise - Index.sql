...
INSERT INTO Products2 (ProductID, ProductName, Category, Price) VALUES
...
SELECT * FROM Products2 WHERE ProductName = 'Laptop';

-- Step 2: Create a non-clustered index on ProductName
CREATE NONCLUSTERED INDEX IX_Products2_ProductName
ON Products2(ProductName);
